                ...
                <div class="col-lg-6">
                    <div class="contact-content">
                        <div class="section-title">
                            <h2>Commençons à nous envoyer un message et à nous contacter</h2>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="contact-another-content">
                        <div class="section-title">
                            <h2>Contacts Info</h2>
                            <p>
                                Nous sommes l'une des meilleures agences et nous pouvons facilement passer un contrat avec nous à tout moment en utilisant les coordonnées ci-dessous.
                            </p>
                        </div>
